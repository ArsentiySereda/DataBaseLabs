...
INSERT INTO Client (phone_number, contact_person, company, adress) VALUES
	...
	('+79269876543', 'Петрова Анна', 'ЗАО "Вектор"', 'СПб, Невский 50'),
	...
	(DEFAULT, 'Алексеева Ольга', 'АО "ЧерМет"', 'Краснодар, Красная 20');
...
INSERT INTO [Credit product] (title, rate, in_parts, min_period, max_period, min_amount, max_amount, condition1, condition2) VALUES
	('Начальный капитал', 12.5, 1, '2024-01-01', '2025-01-01', 500000.00, 10000000.00, 10000.00, 'Бухгалтерская отчетность'),
	('Инвестиционный кредит', 9.0, 1, '2024-01-01', '2030-01-01', 1000000.00, 50000000.00, 50000.00, 'Бизнес-план'),
	('Лизинг оборудования', 11.0, 1, '2024-01-01', '2027-01-01', 300000.00, 20000000.00, 15000.00, 'Договор купли-продажи'),
	('Торговое финансирование', 10.5, 1, '2024-01-01', '2026-01-01', 1000000.00, 30000000.00, 20000.00, ''),
	('Улучшение кредитной истории', 13.0, 1, '2024-01-01', '2028-01-01', 2000000.00, 10000000.00, 30000.00, ''),
	('Факторинг', 15.0, 0, '2024-01-01', '2025-01-01', 100000.00, 5000000.00, 5000.00, 'Дебиторская задолженность'),
	('Авансовый платеж', 17.0, 1, '2024-01-01', '2025-01-01', 50000.00, 5000000.00, 2500.00, 'Государственный контракт'),
	('Рефинансирование', 8.5, 1, '2024-01-01', '2029-01-01', 5000000.00, 50000000.00, 75000.00, 'Действующие кредиты'),
	('Сезонный кредит', 14.0, 1, '2024-01-01', '2025-06-01', 300000.00, 10000000.00, 12000.00, 'Сезонность бизнеса'),
	('Проектное финансирование', 7.5, 1, '2024-01-01', '2032-01-01', 5000000.00, 200000000.00, 100000.00, 'Отчет о дочерних компаниях');
