...
INSERT INTO Client (phone_number, contact_person, company, address) VALUES
	...
	('+79218238593', 'Середа Арсентий', 'АА "Пальчиковые батарейки"', 'Ярославль, Красноборская 34к2'),
	('+79991234567', 'Смирнов Дмитрий', 'ОАО "ДомСтрой"', 'Казань, Баумана 15'),
	...
	('+79998887766', 'Алексеева Ольга', 'ИП "ЧерМет"', 'Краснодар, Красная 20');

INSERT INTO [Credit history] (client_id, bank, number, amount, repayment_date, is_penal) VALUES
	(1, 'Сбербанк', 275712, 500000.00, '2025-03-15', 1),
	(4, 'ВТБ', 28563, 1500000.00, '2023-01-20', 1),
	(1, 'Альфа-Банк', 385763, 750000.50, '2024-02-10', 1),
	(1, 'Тинькофф', 38573, 300000.00, '2024-04-05', 0),
	(4, 'Тинькофф', 23475, 2000000.00, '2023-12-25', 0),
	(5, 'Альфа-Банк', 12360664, 4823837.00, '2024-03-27', 0),
	(2, 'Сбербанк', 2135673, 800000.75, '2025-02-28', 1),
	(6, 'ВТБ', 4349873, 1200000.00, '2025-01-15', 0),
	(8, 'Альфа-Банк', 1238572, 900000.00, '2025-03-20', 0),
	(8, 'Сбербанк', 1234567, 1750000.25, '2023-04-10', 1);

INSERT INTO [Credit product] (title, rate, in_parts, min_period, max_period, min_amount, max_amount, condition1, condition2) VALUES
	('Начальный капитал', 12.5, 1, 24, 60, 500000.00, 10000000.00, 10000.00, 'Бухгалтерская отчетность'),
	('Инвестиционный кредит', 11.0, 0, 24, 120, 1000000.00, 50000000.00, 50000.00, 'Бизнес-план'),
	...
	('Авансовый платеж', 17.0, 1, 25, 36, 50000.00, 5000000.00, 2500.00, 'Государственный контракт'),
	('Рефинансирование', 15.0, 1, 36, 120, 5000000.00, 50000000.00, 75000.00, 'Действующие кредиты'),
	('Сезонный кредит', 12.5, 0, 3, 6, 300000.00, 10000000.00, 12000.00, 'Сезонность бизнеса'),
	('Проектное финансирование', 10.5, 1, 30, 120, 5000000.00, 200000000.00, 100000.00, 'Отчет о дочерних компаниях');

INSERT INTO Deal (client_id, product_id, deal_start, amount, period_, rate) VALUES
	(1, 1, '2025-01-15', 5000000.00, 24, 12.5),
	(1, 3, '2023-02-01', 3000000.00, 36, 11.0),
	(2, 2, '2025-01-20', 10000000.00, 48, 9.0),
	(3, 1, '2024-03-05', 2000000.00, 24, 12.5),
	(3, 5, '2023-02-10', 5000000.00, 48, 13.0),
	(4, 4, '2022-01-25', 8000000.00, 36, 10.5),
	(5, 6, '2023-03-15', 1500000.00, 12, 15.0),
	(6, 7, '2024-02-20', 3000000.00, 18, 17.0),
	(7, 8, '2024-01-30', 10000000.00, 72, 8.5),
	(8, 9, '2025-03-01', 4000000.00, 18, 14.0);
...
INSERT INTO Payment (penalty_id, deal_id, amount, accrual_date, actual_payment_date, in_main_debt, in_early_repayment) VALUES
	(1, 2, 50000.00, '2024-01-01', '2024-01-15', 45000.00, 5000.00),
	(2, 7, 75000.00, '2024-02-01', '2024-02-05', 70000.00, 8000.00),
	(3, 6, 100000.00, '2024-03-01', '2024-03-10', 95000.00, 10000.00),
	(4, 1, 30000.00, '2024-04-01', '2024-04-12', 28000.00, 1000.00),
	(5, 1, 60000.00, '2024-05-01', '2024-05-20', 55000.00, 5000.00),
	(6, 7, 80000.00, '2024-06-01', NULL, 75000.00, 0),
	(7, 4, 120000.00, '2024-07-01', '2024-07-08', 115000.00, 5000.00),
	(8, 8, 25000.00, '2024-08-01', NULL, 23000.00, 2000.00),
	(9, 5, 150000.00, '2024-09-01', '2024-09-25', 145000.00, 5000.00),
